...
#ifndef ENDIANNESS
#define ENDIANNESS 'L'      // 'L' = Little-endian, 'B' = Big-endian (NOTE: For Timonel versions lower than 1.6, set it to Big-endian)
#endif
...
#define MST_PACKET_SIZE 64  // Master-to-Slave Xmit data block size: always even values, min = 2, max = 64
#define SLV_PACKET_SIZE 64  // Slave-to-Master Xmit data block size: always even values, min = 2, max = 64
#ifndef SPM_PAGESIZE
...
#define S_BOOT_ADDR_MSB 7   // Status: Timonel start address MSB position
#define S_APPL_ADDR_LSB 8   // Status: Application address LSB position
#define S_APPL_ADDR_MSB 9   // Status: Application address MSB position
#endif /* ENDIANNESS */
